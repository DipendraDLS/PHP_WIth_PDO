...
try{
 ...
 try{
    ...
    //sql statement
    $sql = "SELECT * From student WHERE id = :id"; //:id  is the named Parameter.

    //prepare statement
    $result = $conn->prepare($sql);

    //Bind Parameter
    $result ->bindParam(':id',$id); //':id' vannale chai database ko column 'id' lai $id vanni varaible sanga bind gareko ho.
    $id = 3;
