...
try{
 ...
 try{
    ...
    //sql statement
    $sql = "SELECT * From student WHERE id = :id"; //?  is the positional Parameter.
    ...
    $result->execute(array(':id'=>3)); //As we haven't used bind concept so we need to pass the array. 
                                      //'3' vaneko yaha id ho.
                                      //if binding concept use nagari execute ko concept matrai use garni ho vaney:-
                                      // yesari key value pair bnayera associative array pass garnu parcha 
