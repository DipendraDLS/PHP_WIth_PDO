...
try{
 ...
 try{
    ...
    //sql statement
    $sql = "SELECT * From student WHERE id = :id && name = :name"; //?  is the positional Parameter.
    ...
    $result->execute(array(':id'=>3, ':name'=>"Dipendra")); //As we haven't used bind concept so we need to pass the array. 
                                                            //'3' vaneko yaha id ho jasma name chai "Dipendra" cha. 
                                                            //yesari key value pair banayera associative array pass garnu parcha.   
