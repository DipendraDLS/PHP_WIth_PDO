...
try{
 ...
 try{
    ...
    //sql statement
    $sql = "SELECT * From student WHERE id = ? && name = ?"; //?  is the positional Parameter.
    ...
    $result->execute(array(3 , "Dipendra"));//As we haven't used bind concept so we need to pass the array. '3' is the id and it has name "Dipendra"`
